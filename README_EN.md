...
| [Development Guide](doc/develop_guide_en.md) | Branch structure, commit conventions, etc. |
| [Minimal Deployment Kit](doc/joblens_simplest_deployable_suite-en.md) | Production deployment guide |
